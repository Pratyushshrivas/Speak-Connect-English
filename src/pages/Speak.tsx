...
import { PhoneCall, ShieldCheck, Timer, Users, MessageCircle, Shuffle, Heart } from "lucide-react";
  ...
  return (
    <main className="container py-10">
      ...
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold mb-4">Practice Speaking — Voice Calls</h1>
